...
from utils.data import iCIFAR224, iImageNetA, colon, skin8, medmnist, covid, blood
import os
import random
...
class DummyDataset(Dataset):
    def __init__(self, images, labels, trsf, use_path=False):
        ...
        self.trsf = transforms.Compose([
            transforms.Resize((224, 224)),  # Resize to a standard model size
...
def _get_idata(dataset_name,use_input_norm):
    ...
    if name== "cifar224":
        ...
        return colon(use_input_norm)
    elif name=="skin8":
        return skin8(use_input_norm)
    elif name=="medmnist":
        return medmnist(use_input_norm)
    elif name=="covid":
        return covid(use_input_norm)
    elif name=="blood":
        return blood(use_input_norm)
